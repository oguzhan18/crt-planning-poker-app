...
export const CreateGame = () => {
  ...
  const [gameName, setGameName] = useState("ÇART APP | Sprint Planning");
  const [createdBy, setCreatedBy] = useState("Joe Doe ");
        ...
        <Card variant="outlined" className="CreateGameCard">
          ...
          <CardContent className="CreateGameCardContent">
            ...
            >
              ...
              />
              <FormControlLabel
                value={GameType.JengalCards}
                control={<Radio color="primary" size="small" />}
                label="Jengal Poker Card (1,2,3,4,5,6,7,8,16,24,32,40,❓,-1)"
              />
            </RadioGroup>
          </CardContent>
