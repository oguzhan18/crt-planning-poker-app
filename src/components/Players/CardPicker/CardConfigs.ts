...
export const jengalCards: CardConfig[] = [
  { value: 1, displayValue: "1", color: "var(--color-background-secondary)" },
  { value: 2, displayValue: "2", color: "#9EC8FE" },
  { value: 3, displayValue: "3", color: "#9EC8FE" },
  { value: 4, displayValue: "4", color: "#A3DFF2" }, 
  { value: 5, displayValue: "5", color: "#9DD49A" },
  { value: 6, displayValue: "6", color: "#9DD49A" },
  { value: 7, displayValue: "7", color: "#9DD49A" },
  { value: 8, displayValue: "8", color: "#9DD49A" }, 
  { value: 16, displayValue: "16", color: "#9DD49A" },
  { value: 24, displayValue: "24", color: "#F4DD94" },
  { value: 32, displayValue: "32", color: "#F4DD94" },  
